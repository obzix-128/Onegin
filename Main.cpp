...
{
    const int SORT_MODE_ARG_COUNT = 3;
    const int HELP_MODE_ARG_COUNT = 2;

    if(argc < HELP_MODE_ARG_COUNT)
    {
    ...
    check_errors = readFile(&eugene_onegin, argv[2], &lines_novel);
